...
const Error = () => {
    return (
        <main className="error">
            ...
            <a href="https://avhcaen.fr/">
                <img src="http://localhost:3000/static/media/logo.d272c8bbb18a1edb56ad.png" alt="logo de l'association renvoyant vers la page d'accueil" />
            </a>
