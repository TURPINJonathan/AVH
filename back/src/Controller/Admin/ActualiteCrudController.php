...
class ActualiteCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('imageFile')->setLabel('Image de l\'actualité')->setFormType(VichImageType::class)->setHelp('Pour une meilleure visibilité, l\'image doit être au format jpg, jpeg, png ou gif et doit faire moins de 2Mo.'),
